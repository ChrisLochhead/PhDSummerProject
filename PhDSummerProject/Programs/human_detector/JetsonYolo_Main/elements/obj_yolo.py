...
class OBJ_DETECTION():
    ...
    def detect(self,main_img, lightweight = False):
        start_time = time.time()
        #print("prediction: organising input data ")
        ...
        if pred[0] is not None and len(pred):
            for p in pred[0]:
                ...
                if int(p[5]) == 0:
                    ...
                    items.append(item)
        #print("packaging done {:.5f}".format(start_time - time.time()))
        return items
